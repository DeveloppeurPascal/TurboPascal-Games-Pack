...
[This repository](https://github.com/DeveloppeurPascal/TurboPascal-Games-Pack) and all projects are available on [my GitHub account](https://github.com/DeveloppeurPascal).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/TurboPascal-Games-Pack) and [open a new issue](https://github.com/DeveloppeurPascal/TurboPascal-Games-Pack/issues).
