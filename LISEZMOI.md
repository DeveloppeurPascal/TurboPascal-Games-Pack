# Pack de jeux vidéo en Turbo Pascal
...
[Ce dépôt de code](https://github.com/DeveloppeurPascal/TurboPascal-Games-Pack) et tous ses sous-projets sont disponibles sur [mon compte GitHub](https://github.com/DeveloppeurPascal).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/TurboPascal-Games-Pack) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/TurboPascal-Games-Pack/issues).
